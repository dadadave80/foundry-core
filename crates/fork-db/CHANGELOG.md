...
## [0.27.0](https://github.com/foundry-rs/foundry-core/releases/tag/fork-db-v0.27.0) - 2026-06-15

### Bug Fixes

- [changelog] Proper grouping, URLs, and per-crate PR routing ([#68](https://github.com/foundry-rs/foundry-core/issues/68))
- [release] Use full tag name in changelog URLs ([#65](https://github.com/foundry-rs/foundry-core/issues/65))

### Dependencies

- Bump revm in fork-db ([#95](https://github.com/foundry-rs/foundry-core/issues/95))
- [fork-db] Bump revm to 40.0.3 ([#75](https://github.com/foundry-rs/foundry-core/issues/75))
- Pin dependencies to patch versions ([#53](https://github.com/foundry-rs/foundry-core/issues/53))

## [0.26.0](https://github.com/foundry-rs/foundry-core/releases/tag/fork-db-v0.26.0) - 2026-04-24
...
> The entries below describe versions released from the upstream
> [foundry-rs/foundry-fork-db](https://github.com/foundry-rs/foundry-fork-db) repo before the migration to foundry-core.
> The upstream repo is now archived; this content is preserved here for reference.
...
- [deps] Bump taiki-e/install-action from 2.67.18 to 2.67.27 ([#105](https://github.com/foundry-rs/foundry-fork-db/issues/105))
- [deps] Bump taiki-e/install-action from 2.67.13 to 2.67.18 ([#104](https://github.com/foundry-rs/foundry-fork-db/issues/104))
- [deps] Bump taiki-e/install-action from 2.66.7 to 2.67.13 ([#102](https://github.com/foundry-rs/foundry-fork-db/issues/102))
- [deps] Bump taiki-e/install-action from 2.66.1 to 2.66.7 ([#100](https://github.com/foundry-rs/foundry-fork-db/issues/100))
